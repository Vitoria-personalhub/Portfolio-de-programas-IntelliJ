...
/* Exercício 10:
 ...
 Usuário: "aluno" /Senha: "0000" = acesso restrito (mostrar: "Bem-vindo, aluno. Você pode consultar as suas notas.").
 Usuário: "professor" /Senha: "4321" = acesso parcial (mostrar: "Bem-vindo, professor. Você pode lançar notas.").
 Observações: Se o usuário existir, mas a senha estiver incorreta, mostrar "Senha incorreta".
